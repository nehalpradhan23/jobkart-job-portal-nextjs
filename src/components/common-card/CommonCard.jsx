...
function CommonCard({ title, icon, description, footerContent }) {
  return (
    <Card className="flex bg-gray-200 border border-black flex-col gap-6 rounded-xl p-8 transition duration-300 hover:bg-white hover:shadow-2xl hover:shadow-gray-400 cursor-pointer">
